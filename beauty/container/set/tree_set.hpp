...
#ifndef beauty__container__set___tree_set_hpp
#define beauty__container__set___tree_set_hpp
...
class tree_set{
	...
	protected:	
	typedef tree_set<Key,Compare,alloc,Tree>            self;
	...
	tree_set(const Compare&c):t(c){}
	
	tree_set(const self &x):t(x.t){}
