...
#ifndef beauty__container__map___hash_map_hpp
#define beauty__container__map___hash_map_hpp
...
class hash_map{
	...
	protected:
	typedef hash_map<Key, Value, HashFun, Compare, alloc>
											                  self;
	...
	hash_map(size_type n):t(n){}

	hash_map(HashFun &hf):t(hf){}

	hash_map(const Compare&c):t(c){}

	hash_map(size_type n, HashFun &hf):t(n, hf){}
	
	hash_map(Compare &e_c, HashFun &hf):t(
		beauty::functor::select1st<
		beauty::container::pair::pair<Key, Value> >(),
		e_c, hf){}

	hash_map(size_type n, Compare &e_c, HashFun &hf):t(n,
		beauty::functor::select1st<
		beauty::container::pair::pair<Key, Value> >(),
		e_c, hf){}
