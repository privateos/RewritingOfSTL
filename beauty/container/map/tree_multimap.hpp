...
#ifndef beauty__container__map___tree_multimap_hpp
#define beauty__container__map___tree_multimap_hpp
...
class tree_multimap{
	...
	protected:	
	typedef tree_multimap<Key, Value, Compare, alloc, Tree>
											            self;
	...
	tree_multimap(const Compare&c):t(c){}
	
	tree_multimap(const self &x):t(x.t){}
